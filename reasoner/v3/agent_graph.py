...
from reasoner.v3.react_agent import ReactAgent, AgentResult
...
from reasoner.v3.highlight_precheck import HighlightPrecheck
from reasoner.v3.reduce_pipeline import ReducePart, ReducePipeline
...
from reasoner.v3.skill_evaluator import evaluate_and_run, select_extra_skills
...
class AgentGraph:
    ...
    def _final_summary(self, skill_context: str = "") -> str:
        """v3 版最终汇总：直接使用 CORPUS_SYSTEM_PROMPT + CORPUS_USER_PROMPT。
